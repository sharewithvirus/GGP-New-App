        ...
        <ScrollView style={{ backgroundColor: Colors.WHITE, flex: 1 }}>
            <ImageBackground source={require('../../images/bg2.png')} style={[commonStyle.fullSize]}>
                ...
                <View style={{ padding: Spacing.PADDING_20 }}>
                    ...
                    <TextInput placeholder='Enter old 4-digit PIN' value={oldPin} onChangeText={(val)=>setOldPin(val)} keyboardType='numeric' style={[styles.input]} />
                    <Text style={[styles.label]}>New PIN:</Text>
                    <TextInput placeholder='Enter new 4-digit PIN' value={newPin} onChangeText={(val)=>setNewPin(val)} keyboardType='numeric' style={[styles.input]} />
