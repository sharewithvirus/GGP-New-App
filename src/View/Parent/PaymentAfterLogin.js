...
export default function PaymentAfterLogin(props) {
    ...
    const getDataOnInit = async () => {
        ...
        console.log(favcyAuthtoken, "favcyAuthtoken")
    ...
    const handleSuccess = async (nav) => {
        props.navigation.navigate("PaymentSuccess", { data: nav.url, paymentObj: props?.route?.params?.orderObj })
    }
    ...
    useEffect(() => {
        ...
        console.log(props.route.params.orderObj)
            ...
            <WebView
                onNavigationStateChange={(navState) => {
                    ...
                    if (`${navState.url}`.toLowerCase().includes("payment-success")) {
                        ...
                        props.navigation.navigate("PaymentFailed", { data: navState.url, paymentObj: props?.route?.params?.orderObj })
