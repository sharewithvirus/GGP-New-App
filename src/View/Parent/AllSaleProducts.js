...
export default function AllSaleProducts(props) {
    ...
    const handleGetProductData = async () => {
        ...
        try {
            ...
            console.log(JSON.stringify(res?.data?.inventory_Data[0]?.item, null, 2), "products")
            if (res.data) {
    ...
    return (
        <>
            ...
            <FlatList
                ListHeaderComponent={
                    <Text style={[commonStyle.title, { color: '#353535', marginTop: 10, marginBottom: 40 }]}>On Sale</Text>
                }
