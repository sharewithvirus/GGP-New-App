...
export default function OrderedProduct() {
    ...
    return (
        ...
        <View style={{ backgroundColor: Colors.WHITE, flex: 1, padding: Spacing.MARGIN_15 }}>
            <Text style={[commonStyle.title, { fontSize: Typography.FONT_SIZE_27, fontWeight: '700', marginBottom: Spacing.MARGIN_15 }]}>Ordered Product</Text>
            <FlatList
                data={data}
