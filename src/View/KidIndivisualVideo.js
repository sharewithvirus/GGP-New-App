...
export default function KidIndivisualVideo(props) {
    ...
    return (
        <View style={{ backgroundColor: Colors.WHITE, flex: 1 }}>
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <>
                        <Text style={[commonStyle.title, { marginTop: hp(4), fontSize: Typography.FONT_SIZE_30, color: Colors.LIGHT_BLACK, }]}>{props?.route?.params?.playlistName}</Text>

                        <Text style={[styles.head, { marginRight: Spacing.PADDING_5, alignSelf: 'center' }]}>{videoArr.length} Videos</Text>
